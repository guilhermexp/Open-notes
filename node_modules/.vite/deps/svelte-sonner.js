...
function create_if_block_2(ctx) {
  ...
  return {
    ...
    h() {
      ...
      attr(path, "d", "M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a.75.75 0 000 1.5h.253a.25.25 0 01.244.304l-.459 2.066A1.75 1.75 0 0010.747 15H11a.75.75 0 000-1.5h-.253a.25.25 0 01-.244-.304l.459-2.066A1.75 1.75 0 009.253 9H9z");
...
function create_if_block_1(ctx) {
  ...
  return {
    ...
    h() {
      attr(path, "fill-rule", "evenodd");
      attr(path, "d", "M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-8-5a.75.75 0 01.75.75v4.5a.75.75 0 01-1.5 0v-4.5A.75.75 0 0110 5zm0 10a1 1 0 100-2 1 1 0 000 2z");
      attr(path, "clip-rule", "evenodd");
      attr(svg, "xmlns", "http://www.w3.org/2000/svg");
      attr(svg, "viewBox", "0 0 20 20");
      attr(svg, "fill", "currentColor");
...
function create_if_block(ctx) {
  ...
  return {
    ...
    h() {
      attr(path, "fill-rule", "evenodd");
      attr(path, "d", "M10 18a8 8 0 100-16 8 8 0 000 16zm3.857-9.809a.75.75 0 00-1.214-.882l-3.483 4.79-1.88-1.88a.75.75 0 10-1.06 1.061l2.5 2.5a.75.75 0 001.137-.089l4-5.5z");
      attr(path, "clip-rule", "evenodd");
      attr(svg, "xmlns", "http://www.w3.org/2000/svg");
      attr(svg, "viewBox", "0 0 20 20");
      attr(svg, "fill", "currentColor");
...
function create_each_block(key_1, ctx) {
  ...
  return {
    ...
    h() {
      attr(div, "class", "sonner-loading-bar");
      this.first = div;
    },
    m(target, anchor) {
...
function create_fragment2(ctx) {
  ...
  return {
    ...
    h() {
      attr(div0, "class", "sonner-spinner");
      attr(div1, "class", "sonner-loading-wrapper");
      attr(
        div1,
        "data-visible",
        /*visible*/
...
function create_if_block_14(ctx) {
  ...
  return {
    ...
    h() {
      ...
      attr(button, "aria-label", "Close toast");
      attr(
        button,
        "data-disabled",
        /*disabled*/
...
function create_else_block_2(ctx) {
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      ctx2[2].title + "")) set_data(t, t_value);
    },
    i: noop,
    o: noop,
    d(detaching) {
...
function create_else_block_1(ctx) {
  ...
  return {
    ...
    p(ctx2, dirty) {
      if (dirty[0] & /*toast*/
      4 && t_value !== (t_value = /*toast*/
      ctx2[2].description + "")) set_data(t, t_value);
    },
    i: noop,
    o: noop,
    d(detaching) {
...
function create_if_block_22(ctx) {
  ...
  return {
    ...
    h() {
      var _a, _b, _c;
      attr(button, "data-button", "");
      attr(button, "data-cancel", "");
      attr(
        button,
        "style",
        /*cancelButtonStyle*/
    ...
    p(ctx2, dirty) {
      ...
      if (dirty[0] & /*toast*/
      4 && t_value !== (t_value = /*toast*/
      ctx2[2].cancel.label + "")) set_data(t, t_value);
...
function create_if_block_15(ctx) {
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      if (dirty[0] & /*toast*/
      4 && t_value !== (t_value = /*toast*/
      ctx2[2].action.label + "")) set_data(t, t_value);
...
function create_fragment3(ctx) {
  ...
  return {
    ...
    h() {
      ...
      attr(li, "aria-live", li_aria_live_value = /*toast*/
      ctx[2].important ? "assertive" : "polite");
      attr(li, "aria-atomic", "true");
      attr(li, "role", "status");
      attr(li, "tabindex", li_tabindex_value = 0);
      attr(li, "class", li_class_value = cn(
        /*$$props*/
        ctx[34].class,
        /*toastClass*/
        ctx[24],
      ...
      attr(li, "data-sonner-toast", "");
      attr(li, "data-styled", li_data_styled_value = !/*toast*/
      ...
      attr(li, "data-promise", li_data_promise_value = Boolean(
        /*toast*/
        ctx[2].promise
      ));
      attr(
      ...
      attr(li, "data-y-position", li_data_y_position_value = /*coords*/
      ctx[21][0]);
      attr(li, "data-x-position", li_data_x_position_value = /*coords*/
      ctx[21][1]);
      attr(
        li,
        "data-index",
      ...
      attr(li, "data-expanded", li_data_expanded_value = Boolean(
        /*expanded*/
        ctx[4] || /*expandByDefault*/
        ctx[5] && /*mounted*/
        ctx[12]
      ));
      attr(li, "style", li_style_value = `${/*$$props*/
      ctx[34].style} ${/*toast*/
      ctx[2].style}`);
      set_style(
        li,
    ...
    p(ctx2, dirty) {
      ...
      ctx2[2].important ? "assertive" : "polite")) {
        attr(li, "aria-live", li_aria_live_value);
      }
      ...
      ctx2[10]))) {
        attr(li, "data-styled", li_data_styled_value);
      }
      ...
      4 && li_data_promise_value !== (li_data_promise_value = Boolean(
        ...
        attr(li, "data-promise", li_data_promise_value);
      }
      ...
      ctx2[21][0])) {
        attr(li, "data-y-position", li_data_y_position_value);
      }
      if (!current || dirty[0] & /*coords*/
      2097152 && li_data_x_position_value !== (li_data_x_position_value = /*coords*/
      ctx2[21][1])) {
        attr(li, "data-x-position", li_data_x_position_value);
      }
      ...
      4144 && li_data_expanded_value !== (li_data_expanded_value = Boolean(
        ...
        attr(li, "data-expanded", li_data_expanded_value);
      }
      if (!current || dirty[0] & /*toast*/
      4 | dirty[1] & /*$$props*/
...
function create_if_block3(ctx) {
  ...
  return {
    ...
    h() {
      attr(section, "aria-label", section_aria_label_value = `${/*containerAriaLabel*/
      ctx[1]} ${/*hotkeyLabel*/
      ctx[16]}`);
      attr(section, "tabindex", section_tabindex_value = -1);
    },
    m(target, anchor) {
...
function fallback_block_3(ctx) {
  let icon;
  let current;
  icon = new Icon_default({ props: { type: "success" } });
  return {
    c() {
...
function fallback_block_2(ctx) {
  let icon;
  let current;
  icon = new Icon_default({ props: { type: "error" } });
  return {
    c() {
      create_component(icon.$$.fragment);
    },
...
function fallback_block_1(ctx) {
  let icon;
  let current;
  icon = new Icon_default({ props: { type: "warning" } });
  return {
    c() {
      create_component(icon.$$.fragment);
    },
...
function fallback_block(ctx) {
  let icon;
  let current;
  icon = new Icon_default({ props: { type: "info" } });
  return {
    c() {
      create_component(icon.$$.fragment);
    },
