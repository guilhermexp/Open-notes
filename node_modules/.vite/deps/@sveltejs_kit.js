import {
  false_default,
  true_default
} from "./chunk-ILHGFR5O.js";
import {
  ActionFailure,
  HttpError,
  Redirect
} from "./chunk-TRTSFSDX.js";
...
function error(status, body) {
  if ((!true_default || false_default) && (isNaN(status) || status < 400 || status > 599)) {
...
function redirect(status, location) {
  if ((!true_default || false_default) && (isNaN(status) || status < 300 || status > 308)) {
