<script lang="ts">
	...
	onMount(() => {
		// Process links after a short delay
		setTimeout(() => {
			processYouTubeLinks();
		}, 500);
		
		// Simple observer for new content (without causing loops)
		let observerTimeout;
